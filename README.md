...
- 采用微内核实现 AutoScan、AOP、IoC、Event等，涵盖 SSH 和 SSM 框架中绝大部分核心功能；
- 统一配置体系结构，感受不一样的文件资源配置及管理模式；
- 整合多种日志系统（Log4j、JCL、Slf4j等）、日志文件可分离存储；
...
- 配置简单的 MVC 架构，强大且易于维护和扩展，支持 RESTful 风格，支持 JSP、HTML、Binary、Freemarker、Velocity等多种视图技术；
...
[点击阅读 >>](https://ymate.net/guide/core.html)
...
[点击阅读 >>](https://ymate.net/guide/configuration.html)



### 日志（Log）

基于开源日志框架 Log4J 2 实现，提供日志记录器对象的统一管理，并整合了 JCL、Slf4J等优秀的日志系统，可以在任意位置调用任意日志记录器输出日志，实现了系统与业务日志的分离，同时与 YMP 配置体系模块配合使用，效果更佳。

[点击阅读 >>](https://ymate.net/guide/log.html)
...
[点击阅读 >>](https://ymate.net/guide/persistence/jdbc.html)
...
[点击阅读 >>](https://ymate.net/guide/persistence/mongodb.html)
...
[点击阅读 >>](https://ymate.net/guide/persistence/redis.html)
...
[点击阅读 >>](https://ymate.net/guide/plugin.html)
...
[点击阅读 >>](https://ymate.net/guide/serv.html)
...
[点击阅读 >>](https://ymate.net/guide/validation.html)
...
[点击阅读 >>](https://ymate.net/guide/cache.html)
...
[点击阅读 >>](https://ymate.net/guide/webmvc.html)
...
[点击阅读 >>](https://ymate.net/guide/commons.html)
...
[点击阅读 >>](https://ymate.net/guide/test)
