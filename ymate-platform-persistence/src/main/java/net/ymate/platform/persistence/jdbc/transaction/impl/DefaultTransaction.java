...
public class DefaultTransaction implements ITransaction {
    ...
    private Type.TRANSACTION __level;
    ...
    private static class TransactionMeta {
         ...
         * @throws SQLException
         */
        TransactionMeta(String dataSourceName, IConnectionHolder connectionHolder, Type.TRANSACTION initLevel) throws SQLException {
