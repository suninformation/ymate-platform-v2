 ...
 * @since 2.1.4
 */
public abstract class AbstractTreeViewExt<ID extends Serializable, CHILD_TYPE extends ITreeViewExt<ID, ? extends CHILD_TYPE>> implements ITreeViewExt<ID, CHILD_TYPE> {
    ...
    public boolean equals(Object o) {
        ...
        AbstractTreeViewExt<?, ?> that = (AbstractTreeViewExt<?, ?>) o;
