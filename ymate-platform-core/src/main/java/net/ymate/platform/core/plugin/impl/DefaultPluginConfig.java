...
import net.ymate.platform.core.plugin.IPluginConfig;
...
public class DefaultPluginConfig implements IPluginConfig {
    ...
    private IPluginParser __pluginParser;

    private IPluginExtendParser __pluginExtendParser;
    ...
    public IPluginParser getPluginParser() {
        return __pluginParser;
    }

    public void setPluginParser(IPluginParser pluginParser) {
        this.__pluginParser = pluginParser;
    }

    public IPluginExtendParser<?> getPluginExtendParser() {
        return __pluginExtendParser;
    }

    public void setPluginExtendParser(IPluginExtendParser pluginExtendParser) {
        this.__pluginExtendParser = pluginExtendParser;
    }
    ...
    public void setManifestFile(String manifestFile) {
        this.__manifestFile = manifestFile;
    }
}
