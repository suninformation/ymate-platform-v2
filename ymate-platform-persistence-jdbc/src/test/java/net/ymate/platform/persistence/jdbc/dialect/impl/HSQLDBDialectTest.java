...
@EnableBeanProxy
@EnableDevMode
public class HSQLDBDialectTest extends DialectTestBase {
    ...
    public void testGetName() {
        ...
        // Type.DATABASE.HSQLDB 的值是 "HSQLDB"（大写）
        org.junit.Assert.assertEquals("HSQLDB", dialect.getName());
    }
    ...
    public void testBuildPagedQuerySql() {
        ...
        // 测试分页查询 - HSQLDB 使用 LIMIT count OFFSET offset 格式
    ...
    public void testBuildUpsertSql() {
        ...
        assertSqlContains(sql, "FROM (VALUES");
