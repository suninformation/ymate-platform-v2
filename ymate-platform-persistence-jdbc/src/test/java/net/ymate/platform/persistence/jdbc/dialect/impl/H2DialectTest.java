...
@EnableBeanProxy
@EnableDevMode
public class H2DialectTest extends DialectTestBase {
    ...
    public void testGetName() {
        ...
        // Type.DATABASE.H2 的值是 "H2"（大写）
        org.junit.Assert.assertEquals("H2", dialect.getName());
    }
    ...
    public void testBuildPagedQuerySql() {
        ...
        // 测试分页查询 - H2 使用 AbstractDialect 的默认实现：LIMIT offset, count
