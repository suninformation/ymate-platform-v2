 ...
 * @since 2.1.4
 */
public class SQLiteDialectTest extends DialectTestBase {
    ...
    public void testGetName() {
        ...
        // Type.DATABASE.SQLITE 的值是 "SQLITE"（大写）
        org.junit.Assert.assertEquals("SQLITE", dialect.getName());
    }
    ...
    public void testBuildPagedQuerySql() {
        ...
        // 测试分页查询 - SQLite 使用 AbstractDialect 的默认实现：LIMIT offset, count
        // page=2, pageSize=10: limit=(2-1)*10=10, 生成 LIMIT 10, 10
        ...
        // 测试第一页: page=1, pageSize=20: limit=0, 生成 LIMIT 0, 20
        ...
        // 测试 pageSize = 0: limit=(3-1)*0=0, 生成 LIMIT 0（注意：当 pageSize=0 时只返回 LIMIT offset）
    ...
    public void testBuildUpsertSql() {
        ...
        // 验证更新部分包含非主键字段，使用 excluded 语法（SQLite 使用小写）
    ...
    public void testBuildUpsertSqlCompositeKey() {
        ...
        // 验证更新部分包含非主键字段（SQLite 使用小写的 excluded）
    ...
    public void testBuildInsertIfNotExistSql() {
        ...
        // 验证使用 INSERT OR IGNORE
        assertSqlContains(sql, "INSERT OR IGNORE INTO");
        assertSqlContains(sql, "test_user");
