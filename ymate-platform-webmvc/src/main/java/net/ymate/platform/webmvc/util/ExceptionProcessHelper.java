...
public final class ExceptionProcessHelper {
    ...
    static {
        ...
        DEFAULT.registerProcessor(FileUploadBase.InvalidContentTypeException.class, target -> new IExceptionProcessor.Result(WebErrorCode.REQUEST_OPERATION_FORBIDDEN, WebErrorCode.MSG_REQUEST_OPERATION_FORBIDDEN));
        DEFAULT.registerProcessor(FileUploadBase.InvalidContentTypeException.class, target -> new IExceptionProcessor.Result(WebErrorCode.REQUEST_METHOD_NOT_ALLOWED, WebErrorCode.MSG_REQUEST_METHOD_NOT_ALLOWED));
        DEFAULT.registerProcessor(FileUploadBase.InvalidContentTypeException.class, target -> new IExceptionProcessor.Result(WebErrorCode.REQUEST_RESOURCE_UNAUTHORIZED, WebErrorCode.MSG_REQUEST_RESOURCE_UNAUTHORIZED));
        DEFAULT.registerProcessor(FileUploadBase.InvalidContentTypeException.class, target -> new IExceptionProcessor.Result(WebErrorCode.RESOURCE_NOT_FOUND_OR_NOT_EXIST, WebErrorCode.MSG_RESOURCE_NOT_FOUND_OR_NOT_EXIST));
        DEFAULT.registerProcessor(FileUploadBase.InvalidContentTypeException.class, target -> new IExceptionProcessor.Result(WebErrorCode.USER_SESSION_INVALID_OR_TIMEOUT, WebErrorCode.MSG_USER_SESSION_INVALID_OR_TIMEOUT));
    }
